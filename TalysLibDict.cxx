...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::OpticalModelParameters*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("OpticalModelParameters", ::OpticalModelParameters::Class_Version(), "TalysLib.hh", 69,
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::SpinParity*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("SpinParity", ::SpinParity::Class_Version(), "TalysLib.hh", 118,
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::GammaTransitionData*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("GammaTransitionData", ::GammaTransitionData::Class_Version(), "TalysLib.hh", 136,
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::GammaTransition*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("GammaTransition", ::GammaTransition::Class_Version(), "TalysLib.hh", 147,
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::LevelData*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("LevelData", ::LevelData::Class_Version(), "TalysLib.hh", 181,
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::LevelDeformation*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("LevelDeformation", ::LevelDeformation::Class_Version(), "TalysLib.hh", 195,
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::Deformation*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("Deformation", ::Deformation::Class_Version(), "TalysLib.hh", 209,
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::Level*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("Level", ::Level::Class_Version(), "TalysLib.hh", 229,
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::NucleusData*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("NucleusData", ::NucleusData::Class_Version(), "TalysLib.hh", 275,
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::Nucleus*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("Nucleus", ::Nucleus::Class_Version(), "TalysLib.hh", 294,
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::TalysCalculation*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("TalysCalculation", ::TalysCalculation::Class_Version(), "TalysLib.hh", 371,
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::SampleInformation*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("SampleInformation", ::SampleInformation::Class_Version(), "TalysLib.hh", 404,
