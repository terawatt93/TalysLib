...
class TLMaterial:public TObject
{
	...
	void SaveToXLSX(string filename);
	GammaPeakData FindGammaTransitionsForPeak(double Energy,double Sigma,double CrossSectionThreshold=0, double Length=0,bool UseAbundancy=true, bool AtLeastOne=false, bool Always_n2n=false);//толщина - в см
